# Regix-Lite
Regix Lite is a lightweight Windows registry optimization tool developed in C as a collaborative student project. The application scans the Windows registry for unused or invalid entries and provides a simple HTML-based graphical user interface for reviewing and safely cleaning system data.
